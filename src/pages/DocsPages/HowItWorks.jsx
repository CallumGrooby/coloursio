...
export const HowItWorks = () => {
  return (
    <div className="docs-container">
      ...
      <p className="content">
        Colours.io has a few main sections: the Playground, the Colour Contrast
      ...
      <p className="content">
        ...
        colours, pick fonts, and see how everything looks in real time. It’s set
      ...
      <h2 className="sub-header">Colour Contrast</h2>
      <p className="content">
        This is where you can test if your colours are accessible. It checks if
        ...
        lighter shades or muted colours and want to make sure everything is
        still readable.
        <br />
        You don't need to calculate anything yourself. Just plug in your colours
        and see the results.
      </p>
    </div>
  );
